...
| 2026-07-15 | index.html | футер: `© 2025` → `© 2026` | застарілий рік | актуальний футер |
| 2026-07-15 | всі 3 HTML | + favicon (інлайновий SVG data-URI, літера «A» у кольорах бренду) | браузер показував стандартну іконку | брендована іконка без зовнішніх файлів |
| 2026-07-15 | index.html, og-image.png | + Open Graph теги (`og:title/description/url/image/locale`, `twitter:card`) і згенероване зображення 1200×630 | бідне прев'ю при шерингу у Facebook — основний канал рекрутингу | повноцінне прев'ю посилання |

⚠️ `og:image` та `og:url` вказують на `https://mikolka317-jpg.github.io/armada-hr/` — при переїзді на власний домен онови ці два абсолютні URL в `index.html`.
