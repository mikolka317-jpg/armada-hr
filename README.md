...
**Для чого:**
- показ актуальних вакансій (кухар, кухар сніданків, офіціант, бармен, покоївка, помічник кухаря, посудомийник; ставки 25–32 zł/год нетто);
...
- `© 2025` у футері — станом на 2026 виглядає застаріло; онови на 2026, якщо це не навмисно.
- Немає favicon — браузер показує стандартну іконку.
- Немає Open Graph тегів (`og:title`, `og:image`) — при шерингу в соцмережах прев'ю виглядає бідно; для рекрутингу через Facebook це варто додати.
